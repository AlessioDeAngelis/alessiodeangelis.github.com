...
var createModel = function(jPoints) {
	var domain1 = INTERVALS(1)(100);
	var domain2 = DOMAIN([[0,1],[0,1]])([100, 100]);
	var plasmPoints = parseJson4PlasmPoints(jPoints);
	//console.log("parsati");
...
var drawModel = function(){
	...
	structArray.push(createModelLowFemur(jsonPoints));//femore basso
	structArray.push(T([0,1,2])([0,0,-1.4])(createModel(femore_alto_json)));//
